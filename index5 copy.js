      ...
      shifts: [
        {
          ...
          end: moment("2018-07-01 02:00", "YYYY-MM-DD HH:mm")
        }, {
          start: moment("2018-07-02 09:00", "YYYY-MM-DD HH:mm"),
          end: moment("2018-07-02 10:00", "YYYY-MM-DD HH:mm")
        }
        // ,
        // {
  ...
  var j = [
    {
      ...
      duration: 2,
      data: {
        start: moment("2018-07-01 11:45", "YYYY-MM-DD HH:mm"),
        end: moment("2018-07-01 01:45", "YYYY-MM-DD HH:mm")
      }
...
//Do Solution's start time match with the Job's availability start tim
